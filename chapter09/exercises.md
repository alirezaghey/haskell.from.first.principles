...
9. `myMinimumBy` takes a comparison function and a list and returns the least element of the list bases on the last value that the comparison return `LT` for.
